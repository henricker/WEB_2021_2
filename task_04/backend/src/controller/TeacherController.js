...
module.exports = class StudentController {
  ...
  async store(request, response) {
    ...
    const teacher = await teacherRepository.create(request.body)
    return response.json({ teacher: teacher.export() })
  }
  ...
  async update(request, response) {
    try {
      ...
      const teacher = await teacherRepository.update(id, request.body)
      return response.json({ teacher: teacher.export() })
    } catch(err) {
